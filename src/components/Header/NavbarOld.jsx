...
const Navbar = () => {
  ...
  const buttonProps = {
    login: {
      ...
      className: `${STYLES.buttonBase} hover:bg- hover:border hover:border-user-orange hover:text-user-orange pt-[12px] pb-[12px]`,
    },
    addBusiness: {
  ...
  return (
    <nav className="h-[67px] w-full inset-0 z-[99] fixed bg-[] backdrop-blur-[64px] shadow-[0px_4px_64px_0px_rgba(0,0,0,0.08)]">
